	...
	batch_size(_batch_size)
{
	...
	std::cout << "LeNet parameters------------------" << std::endl;
	...
	printf("conv1.output_x:%d\n", conv1.output_x);
	printf("conv1.output_y:%d\n", conv1.output_y);
	printf("conv2.output_x:%d\n", conv2.output_x);
	printf("conv2.output_y:%d\n", conv2.output_y);
	printf("conv3.output_x:%d\n", conv3.output_x);
	printf("conv3.output_y:%d\n", conv3.output_y);

	fc.init(
	{ conv3.output_x * conv3.output_y * 120 },
		conv3.output_x * conv3.output_y * 120,
		conv3.y,
		conv3.gradient,
		batch_size);
...
void LeNet::train(unsigned const epoch) {
